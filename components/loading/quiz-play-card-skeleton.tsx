...
/**
 * Displays loading placeholders for the quiz play interface.
 * Keeps page structure stable before client state is available.
 */
export default function QuizPlayCardSkeleton() {
  return (
    <Card className="relative overflow-hidden rounded-xl border-border/50 lg:py-6 xl:py-8 lg:gap-6 xl:gap-8">
      <div className="absolute left-0 top-0 h-full w-1 rounded-l-xl" style={{ backgroundColor: 'var(--chart-4)', opacity: 0.6 }} />
